...
; (function ($) {
    ...
    var retinaLogos = function() {
        var retina = window.devicePixelRatio > 1 ? true : false;
          if(retina) {
              $('.logo-header').find('img').attr( {src:'http://hometq.com//icon/logo-dark.png',width:'172.7',height:'59.96'} );
              $('.logo-footer-style2').find('img').attr( {src:'http://hometq.com//icon/logo-dark.png',width:'172.7',height:'59.96'} );
              $('.logo-footer').find('img').attr( {src:'http://hometq.com//icon/logo-dark.png',width:'140px',height:'50px'} );  
          }
      };       
