                ...
                <div class="top-footer wow fadeInDown">
                    <div class="top-footer-left">
                        <div class="logo-footer">
                            <a href="index.html"><img src="<?php echo base_img('company') ?>photo/<?php echo $company['company_logo']?>" alt="images" width="150px" height="60px"></a>
                        </div>
                    </div>
                            ...
                            <div class="footer-info-item">
                                <div class="phone-call">
                                    ...
                                    <div class="content-phone-call">
                                        <div class="heading-16px-rubik"><a href="tel:<?php echo $company['company_mobile'] ?>"><?php echo $company['company_mobile'] ?></a></div>
                                    </div>
                                </div>
                            </div>
                            <div class="footer-info-items">
                                <div class="email">
                                    ...
                                    <div class="content-email">
                                        <div class="heading-16px-rubik"><a href="mailto:<?php echo $company['company_email'] ?>"><?php echo $company['company_email'] ?></a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="list-footer wow fadeInUp">
                        ...
                        <div class="widgets-menu-2">
                            ...
                            <ul class="list-menu-2 text-decs link-style4">
                                <?php foreach ($policies as $item) : ?>
                                    <li><a class="heading-menu2" href="services.html"><?php echo $item['policies_title'] ?></a> </li>
                                <?php endforeach ?>
                            </ul>
                        </div>
                    </div>
                    <div class="footer-item">
                        <div class="widgets-about padding-top-listfooter">
                            ...
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3108.92751944692!2d105.7975575103029!3d21.034693068973965!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ab40a938cc61%3A0xc85d3ac4f97150af!2zNjkgRMawxqFuZyBRdeG6o25nIEjDoG0sIFF1YW4gSG9hLCBD4bqndSBHaeG6pXksIEjDoCBO4buZaSwgVmnhu4d0IE5hbQ!5e0!3m2!1svi!2s!4v1635145148955!5m2!1svi!2s" width="300" height="300" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                        </div>
                    </div>
                </div>
            </div>
...
<script src="<?php echo base_url() ?>rev-slider/js/extensions/extensionsrevolution.extension.layeranimation.min.js"></script>
<script src="<?php echo base_url() ?>rev-slider/js/extensions/extensionsrevolution.extension.migration.min.js"></script>
<script src="<?php echo base_url() ?>rev-slider/js/extensions/extensionsrevolution.extension.navigation.min.js"></script>
<script src="<?php echo base_url() ?>rev-slider/js/extensions/extensionsrevolution.extension.parallax.min.js"></script>
<script src="<?php echo base_url() ?>rev-slider/js/extensions/extensionsrevolution.extension.slideanims.min.js"></script>
